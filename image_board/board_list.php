...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/MyHomPage/image_board/css/board.css?after2">
        <script src="https://kit.fontawesome.com/1513a75356.js" crossorigin="anonymous"></script>
        <link href="https://fonts.googleapis.com/css2?family=Nanum+Pen+Script&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="./css/normalize.css">
		<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/MyHomPage/image_board/js/board.js"></script>
			...
			<div id="board_box">
				...
				<ul id="board_list">
                    <?php
                        ...
                        $result = mysqli_query($con, $sql); //리절트셋이 저장됨
